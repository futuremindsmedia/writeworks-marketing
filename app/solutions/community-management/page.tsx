...
import { ArrowRight, Users, MessageSquare, TrendingUp, Calendar } from "lucide-react"
  ...
  const challenges = [
    {
      ...
      description: "10,000 members but only 100 active. Not enough content to spark conversations.",
    },
    {
      icon: Users,
      title: "Content Volume",
      description: "Community expects daily posts and responses but team is stretched thin.",
    },
    {
      icon: TrendingUp,
      title: "Growth Plateau",
      description: "Member growth is flat. Need more compelling content to attract and retain members.",
    },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumbs items={[{ label: "Solutions", href: "/solutions" }, { label: "Community Management" }]} />
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8 py-4 border-y border-white/10">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-white/60">Member Growth</div>
              </div>
            </div>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">The Community Management Challenge</h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              Community expectations grow but content resources remain limited
            </p>
          </div>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Transform Your Community?</h2>
            <p className="text-white/70 mb-6">
              Join community managers creating engaging content that drives member growth and loyalty.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
