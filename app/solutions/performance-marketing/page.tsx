...
import { ArrowRight, Target, Clock, AlertTriangle } from "lucide-react"
import { Breadcrumbs } from "@/components/breadcrumbs"

export const metadata = {
  title: "Performance Marketing Solutions | WriteWorks AI",
  description:
    "Drive engagement and growth with AI-powered personalization at scale. Create high-converting campaigns faster.",
}
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Scale Your Performance Marketing</h2>
            <p className="text-white/70 mb-6">Join performance teams driving more conversions with WriteWorks</p>
            <Button
              size="lg"
              className="bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white hover:opacity-90"
              asChild
