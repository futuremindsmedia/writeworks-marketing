...
export const metadata = {
  title: "Marketing & Advertising Writing Software | WriteWorks AI",
  description: "AI-powered writing software for marketing and advertising agencies. Scale campaign content and client deliverables.",
}
  ...
  const challenges = [
    {
      ...
      description: "Running multiple campaigns simultaneously requires massive content volume across channels and formats.",
    },
    {
      icon: Target,
      title: "Client Deliverables",
      description: "Creating presentations, reports, and strategy documents takes time away from creative work.",
    },
    {
      icon: Megaphone,
      title: "Content Variation",
      description: "Adapting campaign messages across platforms, audiences, and formats is time-intensive and repetitive.",
    },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumbs items={[{ label: "Solutions", href: "/solutions" }, { label: "Marketing & Advertising" }]} />
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              AI Writing Software for Marketing & Advertising Agencies
            </h1>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">The Marketing & Advertising Challenge</h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              Balance creative excellence with production volume across multiple campaigns and clients.
            </p>
          </div>
