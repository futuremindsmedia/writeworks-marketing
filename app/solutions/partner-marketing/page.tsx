...
import { ArrowRight, Users, FileX, Handshake, Calendar } from "lucide-react"
  ...
  const challenges = [
    {
      ...
      description: "100+ partners but only enabling 20. Not enough content to scale the channel.",
    },
    {
      icon: FileX,
      title: "Co-Marketing Bottleneck",
      description: "Partners want to collaborate but creating co-branded content takes too long.",
    },
    {
      icon: Handshake,
      title: "Channel Activation",
      description: "Partners enrolled but not actively selling. Need more activation materials.",
    },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumbs items={[{ label: "Solutions", href: "/solutions" }, { label: "Partner Marketing" }]} />
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Partner Marketing Content Writing &amp; Management Software</h1>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8 py-4 border-y border-white/10">
              <div className="text-center">
                ...
                <div className="text-xs text-white/60">Faster Enablement</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">4x</div>
                <div className="text-xs text-white/60">Partner Engagement</div>
              </div>
              <div className="text-center">
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">The Partner Marketing Challenge</h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              Partner ecosystem grows but enablement content can't keep pace
            </p>
          </div>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Transform Partner Marketing?</h2>
            <p className="text-white/70 mb-6">
              Join partner marketing teams creating compelling content that drives channel sales and partner engagement.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
