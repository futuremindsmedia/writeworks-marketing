...
import { ArrowRight, Scale, FileText, Shield, Calendar } from "lucide-react"
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Transform Legal Content?</h2>
            <p className="text-white/70 mb-6">
              Join law firms creating professional content that attracts clients and builds authority.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
