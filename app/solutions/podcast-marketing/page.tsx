...
export default function PodcastMarketingPage() {
  ...
  const challenges = [
    ...
    },
    {
      ...
      description: "Poor descriptions and titles reduce podcast discovery.",
    },
    {
      title: "Inconsistent Publishing",
      description: "Content creation bottlenecks delay episode releases.",
    },
  ]
  ...
  const solutions = [
    {
      ...
      description:
        "Create podcast scripts and outlines that keep listeners engaged.",
      icon: Mic,
    },
    {
      title: "Comprehensive Show Notes",
      description: "Generate detailed show notes with timestamps and links.",
      icon: Headphones,
    },
    {
      title: "Rapid Production",
      description: "Write podcast content 75% faster with AI assistance.",
      icon: Zap,
    },
    {
      title: "Promotional Content",
      description: "Create descriptions, social posts, and marketing copy.",
      icon: Radio,
    },
  ]
  ...
  const audiences = [
    {
      role: "Podcast Hosts",
      description: "Create scripts and show notes faster with AI.",
      icon: Mic,
    },
    {
      role: "Podcast Producers",
      description: "Streamline production with better content workflows.",
      icon: Users,
    },
    {
      role: "Content Marketers",
      description: "Use podcasts as a key content marketing channel.",
      icon: TrendingUp,
    },
    {
      role: "Media Companies",
      description: "Scale podcast production across multiple shows.",
      icon: Award,
    },
  ]

  const jobs = [
    { task: "Podcast episode scripts", time: "1 hour", saved: "75%" },
    { task: "Show notes & timestamps", time: "30 mins", saved: "80%" },
    { task: "Episode descriptions", time: "15 mins", saved: "70%" },
    { task: "Podcast intros & outros", time: "20 mins", saved: "75%" },
    { task: "Social media clips", time: "25 mins", saved: "70%" },
    { task: "Guest interview questions", time: "20 mins", saved: "80%" },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-3 md:px-4 pt-4">
        <nav className="flex items-center justify-center gap-2 text-sm text-white/60">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-white">Podcast Marketing</span>
        </nav>
      </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-2">The Podcast Marketing Challenge</h2>
              <p className="text-white/70">Why podcasts struggle to grow</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">AI-powered podcast content creation</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Time saved on podcast marketing tasks</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Podcast professionals growing audiences</p>
            </div>
      ...
      >
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Grow Your Podcast?</h2>
            <p className="text-white/70 mb-6">
              Join podcasters creating engaging content and show notes with AI.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
