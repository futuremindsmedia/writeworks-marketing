...
import { ArrowRight, DollarSign, Zap, XCircle, Users, TrendingUp, Award, ChevronRight, Home, Calendar, ShoppingCart, Star } from "lucide-react"
import { useEffect, useRef, useState } from "react"

export const metadata = {
  title: "Affiliate Marketing Content Platform | WriteWorks AI",
  description: "Create compelling affiliate content that converts. Product reviews, comparisons, and promotional content at scale.",
}
...
export default function AffiliateMarketingPage() {
  ...
  const challenges = [
    ...
    },
    {
      ...
      description: "Standing out in competitive affiliate niches is challenging.",
    },
    {
      title: "Scaling Limitations",
      description: "Can't produce enough content to cover multiple products and niches.",
    },
  ]
  ...
  const solutions = [
    {
      ...
      description:
        "AI-powered affiliate copy that drives clicks and conversions.",
      icon: DollarSign,
    },
    {
      title: "Detailed Product Reviews",
      description: "Create comprehensive reviews that build trust and authority.",
      icon: Star,
    },
    {
      title: "Rapid Content Creation",
      description: "Write product comparisons and reviews 80% faster.",
      icon: Zap,
    },
    {
      title: "Multi-Product Coverage",
      description: "Scale content across multiple products and affiliate programs.",
      icon: ShoppingCart,
    },
  ]
  ...
  const audiences = [
    {
      ...
      description: "Create conversion-focused content faster with AI.",
      icon: DollarSign,
    },
    {
      role: "Content Publishers",
      description: "Scale affiliate content across multiple niches.",
      icon: Users,
    },
    {
      role: "Niche Site Owners",
      description: "Build authority sites with high-quality reviews.",
      icon: TrendingUp,
    },
    {
      role: "Marketing Agencies",
      description: "Deliver affiliate content services at scale.",
      icon: Award,
    },
  ]

  const jobs = [
    { task: "Product reviews (1500 words)", time: "1 hour", saved: "80%" },
    { task: "Product comparisons", time: "45 mins", saved: "75%" },
    { task: "Best X for Y articles", time: "1.5 hours", saved: "70%" },
    { task: "Buying guides", time: "1 hour", saved: "75%" },
    { task: "Affiliate email sequences", time: "30 mins", saved: "80%" },
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-2">The Affiliate Marketing Challenge</h2>
              <p className="text-white/70">Why affiliate content underperforms</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">AI-powered affiliate content that converts</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Time saved on affiliate marketing tasks</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Affiliate professionals driving revenue</p>
            </div>
      ...
      >
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Scale Your Affiliate Revenue?</h2>
            <p className="text-white/70 mb-6">
              Join affiliate marketers creating high-converting content with AI.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
