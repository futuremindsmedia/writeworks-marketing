...
export const metadata = {
  title: "Customer Education Writing Software | WriteWorks AI",
  description: "AI-powered writing software for customer education teams. Train and onboard users with engaging learning content.",
}
  ...
  const challenges = [
    {
      ...
      description: "Need 50 courses but only have 10. Can't create training content fast enough for customers.",
    },
    {
      icon: BookOpen,
      title: "Onboarding Gap",
      description: "Customers churn during onboarding. Not enough guided content to drive activation.",
    },
    {
      icon: Users,
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumbs items={[{ label: "Solutions", href: "/solutions" }, { label: "Customer Education" }]} />
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              AI Writing Software for Customer Education
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8 py-4 border-y border-white/10">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-white/60">Course Completion</div>
              </div>
              <div className="text-center">
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">The Customer Education Challenge</h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              Customer base grows but education content creation can't keep up
            </p>
          </div>
