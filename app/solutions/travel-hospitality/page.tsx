...
export const metadata = {
  title: "Travel & Hospitality Writing Software | WriteWorks AI",
  description: "AI-powered writing software for travel and hospitality businesses. Create inspiring content that drives bookings.",
}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              AI Writing Software for Travel & Hospitality
            </h1>
