...
export const metadata = {
  title: "Native Advertising Writing Platform | WriteWorks AI",
  description: "Create sponsored content that blends seamlessly. AI-powered native advertising and sponsored article writing.",
}
