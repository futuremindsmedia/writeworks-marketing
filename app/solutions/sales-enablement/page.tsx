...
import { ArrowRight, TrendingUp, FileX, Target, Calendar } from "lucide-react"
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Accelerate Sales Enablement?</h2>
            <p className="text-white/70 mb-6">
              Join sales enablement teams creating winning content that drives revenue.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
