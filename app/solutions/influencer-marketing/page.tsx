...
import { ArrowRight, Users, Zap, XCircle, TrendingUp, Award, ChevronRight, Home, Calendar, UserCheck, Sparkles } from "lucide-react"
import { useEffect, useRef, useState } from "react"

export const metadata = {
  title: "Influencer Marketing Writing Platform | WriteWorks AI",
  description: "Streamline influencer collaboration with AI-powered briefs, scripts, and content guidelines. Scale influencer campaigns.",
}
...
export default function InfluencerMarketingPage() {
  ...
  const challenges = [
    ...
    },
    {
      ...
      description: "Creating detailed briefs for each influencer takes too much time.",
    },
    {
      title: "Scaling Difficulties",
      description: "Can't scale influencer programs without massive resource investment.",
    },
  ]

  const solutions = [
    {
      title: "Streamlined Briefs",
      description:
        "Create detailed influencer briefs 75% faster with AI assistance.",
      icon: Users,
    },
    {
      title: "Brand Guidelines",
      description: "Generate consistent messaging frameworks for all influencers.",
      icon: Sparkles,
    },
    {
      title: "Campaign Templates",
      description: "Rapid deployment of influencer campaigns at scale.",
      icon: Zap,
    },
    {
      title: "Content Scripts",
      description: "Create talking points and scripts for influencer content.",
      icon: UserCheck,
    },
  ]
  ...
  const audiences = [
    {
      role: "Influencer Managers",
      description: "Coordinate campaigns faster with AI-powered briefs.",
      icon: Users,
    },
    {
      role: "Brand Teams",
      description: "Maintain brand consistency across influencer content.",
      icon: UserCheck,
    },
    {
      role: "Marketing Agencies",
      description: "Scale influencer services for multiple clients.",
      icon: TrendingUp,
    },
    {
      role: "Social Media Teams",
      description: "Execute influencer campaigns more efficiently.",
      icon: Award,
    },
  ]

  const jobs = [
    { task: "Influencer briefs", time: "30 mins", saved: "75%" },
    { task: "Campaign guidelines", time: "45 mins", saved: "70%" },
    { task: "Content scripts & talking points", time: "25 mins", saved: "80%" },
    { task: "Brand messaging frameworks", time: "1 hour", saved: "65%" },
    { task: "Partnership agreements", time: "40 mins", saved: "70%" },
    { task: "Performance reports", time: "30 mins", saved: "75%" },
  ]
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-4xl mx-auto text-center">
            <div>
              ...
              <div className="text-sm text-white/60">Faster Briefs</div>
            </div>
            <div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-2">The Influencer Marketing Challenge</h2>
              <p className="text-white/70">Why influencer campaigns fall short</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">AI-powered influencer collaboration at scale</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Time saved on influencer marketing tasks</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Teams managing influencer partnerships</p>
            </div>
      ...
      >
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Scale Your Influencer Marketing?</h2>
            <p className="text-white/70 mb-6">
              Join brands streamlining influencer collaborations with AI.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
