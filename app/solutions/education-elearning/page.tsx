...
export const metadata = {
  title: "Education & E-learning Writing Software | WriteWorks AI",
  description: "AI-powered writing software for educational institutions and e-learning platforms. Create engaging course content faster.",
}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              AI Writing Software for Education & E-learning
            </h1>
