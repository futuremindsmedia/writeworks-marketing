...
import { ArrowRight, Video, Zap, XCircle, Users, TrendingUp, Award, ChevronRight, Home, Calendar, Play, Film } from "lucide-react"
import { useEffect, useRef, useState } from "react"

export const metadata = {
  title: "Video Marketing Writing Platform | WriteWorks AI",
  description: "Write video scripts, YouTube descriptions, and video marketing content. AI-powered video copywriting platform.",
}
...
export default function VideoMarketingPage() {
  ...
  const challenges = [
    ...
    },
    {
      ...
      description: "Video descriptions and titles don't rank or drive discovery.",
    },
    {
      title: "Inconsistent Content",
      description: "Maintaining a regular video schedule is challenging.",
    },
  ]

  const solutions = [
    {
      title: "Engaging Scripts",
      description:
        "Create video scripts that hook viewers and drive engagement.",
      icon: Video,
    },
    {
      title: "Optimized Descriptions",
      description: "Write YouTube descriptions that improve discoverability.",
      icon: Film,
    },
    {
      title: "Rapid Script Creation",
      description: "Generate video scripts 75% faster than manual writing.",
      icon: Zap,
    },
    {
      title: "Multi-Format Support",
      description: "Scripts for tutorials, reviews, ads, and social content.",
      icon: Play,
    },
  ]
  ...
  const audiences = [
    {
      ...
      description: "Create scripts and content faster with AI assistance.",
      icon: Video,
    },
    {
      role: "YouTube Creators",
      description: "Scale video production with better scripts and descriptions.",
      icon: Users,
    },
    {
      role: "Content Producers",
      description: "Streamline video content creation workflows.",
      icon: TrendingUp,
    },
    {
      role: "Marketing Teams",
      description: "Produce video marketing content at scale.",
      icon: Award,
    },
  ]

  const jobs = [
    { task: "Video scripts (5-10 min)", time: "45 mins", saved: "75%" },
    { task: "YouTube descriptions", time: "15 mins", saved: "80%" },
    { task: "Video ad scripts", time: "20 mins", saved: "70%" },
    { task: "Tutorial scripts", time: "1 hour", saved: "65%" },
    { task: "Video titles & hooks", time: "10 mins", saved: "85%" },
    { task: "Social video captions", time: "15 mins", saved: "75%" },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-3 md:px-4 pt-4">
        <nav className="flex items-center justify-center gap-2 text-sm text-white/60">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-white">Video Marketing</span>
        </nav>
      </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-4xl mx-auto text-center">
            <div>
              ...
              <div className="text-sm text-white/60">Faster Scripts</div>
            </div>
            <div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-2">The Video Marketing Challenge</h2>
              <p className="text-white/70">Why video content underperforms</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">AI-powered video content creation</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Time saved on video marketing tasks</p>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">Video professionals creating engaging content</p>
            </div>
      ...
      >
        <div className="container mx-auto px-3 md:px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Transform Your Video Marketing?</h2>
            <p className="text-white/70 mb-6">
              Join video marketers creating engaging scripts and content with AI.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                size="lg"
