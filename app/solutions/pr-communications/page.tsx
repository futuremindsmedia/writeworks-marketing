...
export const metadata = {
  ...
  description: "Move fast without losing control. Craft clear, aligned messaging with AI-powered PR tools.",
}
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">AI PR Writing Tool for Modern Communications Teams</h1>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">Real productivity gains for PR and communications teams</p>
          </div>
      ...
      <section className="py-12 md:py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Transform Your PR</h2>
            <p className="text-white/70 mb-6">Join PR teams using WriteWorks to move faster without losing control</p>
            <Button
              size="lg"
              className="bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white hover:opacity-90"
              asChild
