...
export const metadata = {
  title: "Content Marketing Platform | WriteWorks AI",
  description: "Scale your content marketing with AI. Create blog posts, articles, and thought leadership content that drives traffic.",
}
