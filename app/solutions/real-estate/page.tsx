...
export const metadata = {
  title: "Real Estate Writing Software | WriteWorks AI",
  description: "AI-powered writing software for real estate professionals. Create compelling property listings and marketing materials.",
}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mt-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              AI Writing Software for Real Estate
            </h1>
