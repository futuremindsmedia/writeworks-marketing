...
function getRoutes() {
  const routes: { [key: string]: { name: string; path: string }[] } = {
    ...
    Solutions: [
      ...
      { name: "Demand Generation", path: "/solutions/demand-generation" },
      { name: "Customer Marketing", path: "/solutions/customer-marketing" },
      { name: "Partner Marketing", path: "/solutions/partner-marketing" },
      { name: "Growth Marketing", path: "/solutions/growth-marketing" },
      { name: "Corporate Communications", path: "/solutions/corporate-communications" },
      { name: "Technical Writing", path: "/solutions/technical-writing" },
      { name: "Sales Enablement", path: "/solutions/sales-enablement" },
      { name: "Customer Education", path: "/solutions/customer-education" },
      { name: "Community Management", path: "/solutions/community-management" },
      { name: "Analyst Relations", path: "/solutions/analyst-relations" },
